package com.inspection.app.vlook;
...
import com.inspection.app.vlook.ProgressView.State;
...
public class FFmpegRecorderActivity extends Activity implements
	...
	Button flashIcon = null, cancelBtn, nextBtn = null;
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.vlook_recorder);
	...
	public class AsyncStopRecording extends AsyncTask<Void, Integer, Void> {
		...
		protected void onPreExecute() {
			...
			creatingProgress.setContentView(R.layout.vlook_recorder_progress);
	...
	private void showCancellDialog() {
		...
		CustomLockDoubleDialog.Builder builder = new CustomLockDoubleDialog.Builder(FFmpegRecorderActivity.this);
		builder.setTitle("提示");
